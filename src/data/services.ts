...
export const services: ServiceData[] = [
  {
    ...
    priceList: [
      ...
      { service: "Skardinis ratlankis (R13–R16) – nuėmimas/uždėjimas", price: "5 €" },
      { service: "Lietas ratlankis (R13–R16) – montavimas", price: "2,5 €" },
      { service: "Lietas ratlankis (R13–R16) – balansavimas", price: "4 €" },
      { service: "Lietas ratlankis (R13–R16) – nuėmimas/uždėjimas", price: "5 €" },
      { service: "Lietas ratlankis (R17–R18) – montavimas", price: "3 €" },
      { service: "Lietas ratlankis (R17–R18) – balansavimas", price: "4,5 €" },
      { service: "Lietas ratlankis (R17–R18) – nuėmimas/uždėjimas", price: "5 €" },
      { service: "Lietas ratlankis (R19) – montavimas", price: "5 €" },
      { service: "Lietas ratlankis (R19) – balansavimas", price: "5 €" },
      { service: "Lietas ratlankis (R19) – nuėmimas/uždėjimas", price: "5 €" },
      { service: "Lietas ratlankis (R20–R22) – montavimas", price: "6 €" },
      { service: "Lietas ratlankis (R20–R22) – balansavimas", price: "6 €" },
      { service: "Lietas ratlankis (R20–R22) – nuėmimas/uždėjimas", price: "6 €" },
    ],
    faq: [
      {
